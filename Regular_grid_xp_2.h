...
class Regular_grid_xp_2
{
public:
  typedef Regular_grid_xp_2<StreamLinesTraits_2> Vector_field_2;
...
public:
  Regular_grid_xp_2(int m, int n,const FT & x, const FT & y);
  //   Regular_grid_2();
  ~Regular_grid_xp_2()
  {}
  ...
  void set_point_classifier(PointClassifier * is_stop_pointa) {
	  is_stop_point = is_stop_pointa;
  }
...
template <class StreamLinesTraits_2>
inline
typename Regular_grid_xp_2<StreamLinesTraits_2>::Geom_traits::Iso_rectangle_2
Regular_grid_xp_2<StreamLinesTraits_2>::bbox() const
{
...
template <class StreamLinesTraits_2>
inline int
Regular_grid_xp_2<StreamLinesTraits_2>::get_index(int i, int j) const
{
  return 2*(number_of_samples_x*j + i);
}

template <class StreamLinesTraits_2>
Regular_grid_xp_2<StreamLinesTraits_2>::Regular_grid_xp_2(int m,
						    int
						    n,const FT & x,
						    const FT & y)
{
...
template <class StreamLinesTraits_2>
inline typename Regular_grid_xp_2<StreamLinesTraits_2>::Vector_2
Regular_grid_xp_2<StreamLinesTraits_2>::get_field(int i, int j) const
{
...
template <class StreamLinesTraits_2>
inline void
Regular_grid_xp_2<StreamLinesTraits_2>::set_field(int i,
...
template <class StreamLinesTraits_2>
inline bool
Regular_grid_xp_2<StreamLinesTraits_2>::is_in_domain(const Point_2 & p)
  const
{
  bool old_cond = ((p.x()>=0.0) && (p.x()<=domain_size_x) && (p.y()>=0.0) &&
	  (p.y()<=domain_size_y));

  return old_cond && !(*is_stop_point)(p.x(), p.y());
}

template <class StreamLinesTraits_2>
bool
Regular_grid_xp_2<StreamLinesTraits_2>::is_in_samples(int i,
						   int j)
  const
{
...
template <class StreamLinesTraits_2>
typename Regular_grid_xp_2<StreamLinesTraits_2>::Vector_2
Regular_grid_xp_2<StreamLinesTraits_2>::get_vector_field(const Point_2 &
						      p) const
{
  FT fXv,fYv;
...
template <class StreamLinesTraits_2>
typename Regular_grid_xp_2<StreamLinesTraits_2>::FT
Regular_grid_xp_2<StreamLinesTraits_2>::get_density_field(const Point_2 & ) const
...
inline
typename Regular_grid_xp_2<StreamLinesTraits_2>::FT
Regular_grid_xp_2<StreamLinesTraits_2>::get_integration_step(const Point_2 &)
  const
{
  return 1.0;
}
...
inline
typename Regular_grid_xp_2<StreamLinesTraits_2>::FT
Regular_grid_xp_2<StreamLinesTraits_2>::get_integration_step() const
{
  return 1.0;
}
